...
void CELF<ELFSTRUCTURES>::ParseFile(){
   ...
   for (i = 0; i < NSections; i++) {
      ...
      if (SectionHeaders[i].sh_offset > GetDataSize() || SectionHeaders[i].sh_offset + SectionHeaders[i].sh_size > GetDataSize() || SectionHeaders[i].sh_offset + SectionHeaders[i].sh_entsize > GetDataSize()) err.submit(2035);
